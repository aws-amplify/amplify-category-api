import {
  $TSMeta, AmplifyCategories, AmplifySupportedService, stateManager, pathManager,
 ...
 *
 */
export const getAppSyncAPINames = () => Object.entries(stateManager.getMeta()?.api || {})
 ...
 * @param apiName
 */
export const getAPIResourceDir = (apiName: string) => path.join(pathManager.getBackendDirPath(), AmplifyCategories.API, apiName);
...
const getAppSyncAmplifyMetaEntry = (projectMeta: $TSMeta) => Object.entries(projectMeta[AmplifyCategories.API] || {}).find(
