...
export const checkForUnsupportedDirectives = (schema: string, modelToDatasourceMap: Record<string, DatasourceType>): void => {
  ...
  const rdsModels = Object.entries(modelToDatasourceMap)
