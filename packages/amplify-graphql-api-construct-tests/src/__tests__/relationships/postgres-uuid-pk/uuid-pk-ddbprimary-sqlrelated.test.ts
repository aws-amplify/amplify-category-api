    ...
    beforeAll(async () => {
      ...
      const testDefinitions: Record<string, TestDefinition> = {
        ...
        'sql-related': {
          ...
          strategy: dbDetailsToModelDataSourceStrategy(dbDetails, 'sqlrelated', 'POSTGRES', 'secretsManagerManagedSecret'),
        },
      };

      writeStackConfig(projRoot, { prefix: 'UuidPkDdbSql', useSandbox: true });
