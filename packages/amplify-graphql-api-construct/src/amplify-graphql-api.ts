...
export class AmplifyGraphqlApi<SchemaType = AmplifyGraphqlApiResources> extends Construct {
  ...
  constructor(scope: Construct, id: string, props: AmplifyGraphqlApiProps<SchemaType>) {
    ...
    //   this.transformerGeneratedResolvers = Object.fromEntries([
    //     ...this.resources.cfnResolvers,
    //     ...this.resources.cfnFunctionConfigurations,
    //   ].flatMap((resOrFun: CfnResolver) => {
    //     const results = [];
    //     if (resOrFun.requestMappingTemplate) results.push([
    //       `${resOrFun.typeName}.${resOrFun.fieldName}.${resOrFun}`,
    //       resOrFun.requestMappingTemplate,
    //     ]);
    //     if (resOrFun.responseMappingTemplate) results.push(['', resOrFun.responseMappingTemplate]);
    //     return results;
    //   }))
  }
