...
export interface AmplifyGraphqlApiProps {
   ...
   */
  readonly schema: AmplifyGraphqlApiSchema;
   ...
   */
  readonly schemaTranslationBehavior?: SchemaTranslationBehavior;
};
...
export interface AmplifyGraphqlApiResources {
   ...
   */
  readonly cfnPolicies: Record<string, CfnPolicy>;
