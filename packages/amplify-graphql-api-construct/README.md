...
- *Implements:* aws-cdk-lib.aws_appsync.IGraphqlApi
...
| <code><a href="#@aws-amplify/graphql-api-construct.AmplifyGraphqlApi.addSchemaDependency">addSchemaDependency</a></code> | Proxy call to Graphql API addSchemaDependency in order to implement IGraphqlApi interface. |
| <code><a href="#@aws-amplify/graphql-api-construct.AmplifyGraphqlApi.applyRemovalPolicy">applyRemovalPolicy</a></code> | Proxy call to Graphql API applyRemovalPolicy in order to implement IGraphqlApi interface. |
| <code><a href="#@aws-amplify/graphql-api-construct.AmplifyGraphqlApi.createResolver">createResolver</a></code> | Proxy call to Graphql API addSchemaDependency in order to implement IGraphqlApi interface. |
...
##### `addSchemaDependency` <a name="addSchemaDependency" id="@aws-amplify/graphql-api-construct.AmplifyGraphqlApi.addSchemaDependency"></a>
...
###### `construct`<sup>Required</sup> <a name="construct" id="@aws-amplify/graphql-api-construct.AmplifyGraphqlApi.addSchemaDependency.parameter.construct"></a>

- *Type:* aws-cdk-lib.CfnResource

construct to proxy into `addSchemaDependency`.

---

##### `applyRemovalPolicy` <a name="applyRemovalPolicy" id="@aws-amplify/graphql-api-construct.AmplifyGraphqlApi.applyRemovalPolicy"></a>
...
###### `policy`<sup>Required</sup> <a name="policy" id="@aws-amplify/graphql-api-construct.AmplifyGraphqlApi.applyRemovalPolicy.parameter.policy"></a>

- *Type:* aws-cdk-lib.RemovalPolicy

policy to proxy into `applyRemovalPolicy`.

---

##### `createResolver` <a name="createResolver" id="@aws-amplify/graphql-api-construct.AmplifyGraphqlApi.createResolver"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@aws-amplify/graphql-api-construct.AmplifyGraphqlApi.createResolver.parameter.id"></a>

- *Type:* string

id to proxy into `addResolver`.

---

###### `props`<sup>Required</sup> <a name="props" id="@aws-amplify/graphql-api-construct.AmplifyGraphqlApi.createResolver.parameter.props"></a>

- *Type:* aws-cdk-lib.aws_appsync.ExtendedResolverProps

props to proxy into `addResolver`.
...
| <code><a href="#@aws-amplify/graphql-api-construct.AmplifyGraphqlApi.property.arn">arn</a></code> | <code>string</code> | Generated Api ARN. |
| <code><a href="#@aws-amplify/graphql-api-construct.AmplifyGraphqlApi.property.env">env</a></code> | <code>aws-cdk-lib.ResourceEnvironment</code> | ResourceEnvironment returned from L2 Graphql Api. |
...
| <code><a href="#@aws-amplify/graphql-api-construct.AmplifyGraphqlApi.property.stack">stack</a></code> | <code>aws-cdk-lib.Stack</code> | Stack returned from L2 Graphql API. |
...
##### `arn`<sup>Required</sup> <a name="arn" id="@aws-amplify/graphql-api-construct.AmplifyGraphqlApi.property.arn"></a>
...
##### `env`<sup>Required</sup> <a name="env" id="@aws-amplify/graphql-api-construct.AmplifyGraphqlApi.property.env"></a>
...
ResourceEnvironment returned from L2 Graphql Api.
...
##### `stack`<sup>Required</sup> <a name="stack" id="@aws-amplify/graphql-api-construct.AmplifyGraphqlApi.property.stack"></a>
...
Stack returned from L2 Graphql API.
