...
```typescript
  ...
  // Access L1 resoucres under `.resources.cfnResources`
  api.resources.cfnResources.cfnGraphqlApi.xrayEnabled = true
  Object.values(api.resources.cfnResources.cfnTables)
    .forEach(table => table.pointInTimeRecoverySpecification = { pointInTimeRecoveryEnabled: false })```
