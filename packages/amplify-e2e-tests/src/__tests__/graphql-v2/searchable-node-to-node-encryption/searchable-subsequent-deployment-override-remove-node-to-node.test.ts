...
describe('searchable deployment user flag overrides previous deployment state - will recreate table if set toggled from true to false', () => {
  let projRoot: string;
  ...
  it('if previous deployment had NodeToNodeEncryption, and flag is set to false on subsequent push, deploy, search domain will be recreated', async () => {
