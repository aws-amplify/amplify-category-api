 ...
 *
 * @param cwd
 * @param autoCompletePrefix
 * @param clientNames
 * @param clientNames.web
 * @param clientNames.native
 */
export const importUserPoolOnly = (cwd: string, autoCompletePrefix: string, clientNames?: { web?: string; native?: string }) => new Promise((resolve, reject) => {
 ...
 * @param clientNames.native
 */
export const importIdentityPoolAndUserPool = (cwd: string, autoCompletePrefix: string, clientNames?: { web?: string; native?: string }) => new Promise((resolve, reject) => {
  const chain = spawn(getCLIPath(), ['auth', 'import'], { cwd, stripColors: true })
    .wait('What type of auth resource do you want to import')
    .sendCarriageReturn()
    .wait('Select the User Pool you want to import')
 ...
 * @param cwd
 */
export const removeImportedAuthWithDefault = (cwd: string) => new Promise((resolve, reject) => {
 ...
 * @param settings
 */
export const addS3WithAuthConfigurationMismatchErrorExit = (cwd: string, settings: any) => new Promise((resolve, reject) => {
 ...
 *
 * @param projectRoot
 * @param amplifyParameters
 * @param providersParameter
 * @param errorMessage
 * @param categoriesParameter
 ...
 * @param autoCompletePrefix
 */
export const importS3 = (cwd: string, autoCompletePrefix: string): Promise<void> => new Promise((resolve, reject) => {
 ...
 * @param cwd
 */
export const removeImportedS3WithDefault = (cwd: string): Promise<void> => new Promise((resolve, reject) => {
 ...
 * @param autoCompletePrefix
 */
export const importDynamoDBTable = (cwd: string, autoCompletePrefix: string): Promise<void> => new Promise((resolve, reject) => {
  spawn(getCLIPath(), ['storage', 'import'], { cwd, stripColors: true })
    .wait('Select from one of the below mentioned services')
    .sendKeyDown()
    .sendCarriageReturn()
 ...
 * @param cwd
 */
export const removeImportedDynamoDBWithDefault = (cwd: string): Promise<void> => new Promise((resolve, reject) => {
  spawn(getCLIPath(), ['storage', 'remove'], { cwd, stripColors: true })
    .wait('Choose the resource you would want to remove')
    .sendCarriageReturn()
    .wait('Are you sure you want to unlink this imported resource')
