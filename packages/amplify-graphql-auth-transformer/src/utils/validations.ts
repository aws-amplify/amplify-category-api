...
import type { TransformParameters, DataSourceStrategiesProvider } from '@aws-amplify/graphql-transformer-interfaces';
import { ObjectTypeDefinitionNode, InterfaceTypeDefinitionNode, ObjectTypeExtensionNode } from 'graphql';
...
export const commonRuleValidation = (rule: AuthRule): void => {
