...
const STACK_NAME = `RelationalWithAuthV2Redacted-${BUILD_TIMESTAMP}`;
const BUCKET_NAME = `appsync-relational-auth-v2-redacted-test-${BUILD_TIMESTAMP}`;
const LOCAL_FS_BUILD_DIR = '/tmp/relational_auth_v2_redacted_test/';
