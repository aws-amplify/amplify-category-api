...
## [9.0.3-ai.1](https://github.com/aws-amplify/amplify-category-api/compare/amplify-category-api-graphql-transformers-e2e-tests@9.0.3-ai.0...amplify-category-api-graphql-transformers-e2e-tests@9.0.3-ai.1) (2024-09-26)

**Note:** Version bump only for package amplify-category-api-graphql-transformers-e2e-tests

## [9.0.3-ai.0](https://github.com/aws-amplify/amplify-category-api/compare/amplify-category-api-graphql-transformers-e2e-tests@9.0.2...amplify-category-api-graphql-transformers-e2e-tests@9.0.3-ai.0) (2024-09-20)
