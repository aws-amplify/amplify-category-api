...
const getDefaultLayerMapping = (): RDSLayerMapping => ({
  ...
  'cn-north-1': {
    layerRegion: 'arn:aws:lambda:cn-north-1:582037449441:layer:AmplifyRDSLayer:8',
  },
  'cn-northwest-1': {
    layerRegion: 'arn:aws:lambda:cn-northwest-1:582037449441:layer:AmplifyRDSLayer:8',
  },
  'us-gov-west-1': {
    layerRegion: 'arn:aws:lambda:us-gov-west-1:582037449441:layer:AmplifyRDSLayer:8',
  },
  'us-gov-east-1': {
    layerRegion: 'arn:aws:lambda:us-gov-east-1:582037449441:layer:AmplifyRDSLayer:8',
  },
  'me-south-1': {
