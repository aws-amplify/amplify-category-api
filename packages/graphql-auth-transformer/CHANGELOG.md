...
## [7.2.45-beta.3](https://github.com/aws-amplify/amplify-category-api/compare/graphql-auth-transformer@7.2.45...graphql-auth-transformer@7.2.45-beta.3) (2022-12-27)

**Note:** Version bump only for package graphql-auth-transformer

## [7.2.45-beta.2](https://github.com/aws-amplify/amplify-category-api/compare/graphql-auth-transformer@7.2.45-beta.0...graphql-auth-transformer@7.2.45-beta.2) (2022-12-12)

**Note:** Version bump only for package graphql-auth-transformer

## [7.2.45-beta.1](https://github.com/aws-amplify/amplify-category-api/compare/graphql-auth-transformer@7.2.45-beta.0...graphql-auth-transformer@7.2.45-beta.1) (2022-11-30)

**Note:** Version bump only for package graphql-auth-transformer

## [7.2.45-beta.0](https://github.com/aws-amplify/amplify-category-api/compare/graphql-auth-transformer@7.2.45-cdkv2.1...graphql-auth-transformer@7.2.45-beta.0) (2022-11-18)

**Note:** Version bump only for package graphql-auth-transformer

## [7.2.45-cdkv2.1](https://github.com/aws-amplify/amplify-category-api/compare/graphql-auth-transformer@7.2.45-cdkv2.0...graphql-auth-transformer@7.2.45-cdkv2.1) (2022-11-15)
