...
test('"create", "update", "delete" auth operations', () => {
  ...
  expect(out.resolvers['Query.listPosts.res.vtl']).not.toContain('Authorization rule:');
  expect(out.resolvers['Query.listPosts.res.vtl']).toMatchSnapshot();
  expect(out.resolvers['Mutation.createPost.req.vtl']).toContain('Authorization rule:');
  expect(out.resolvers['Mutation.createPost.req.vtl']).toMatchSnapshot();
  expect(out.resolvers['Mutation.updatePost.req.vtl']).toContain('Authorization rule:');
  expect(out.resolvers['Mutation.updatePost.req.vtl']).toMatchSnapshot();
  expect(out.resolvers['Mutation.deletePost.req.vtl']).toContain('Authorization rule:');
...
test('that checks subscription resolvers are generated with auth logic', () => {
  ...
  expect(out.resolvers['Subscription.onDeleteSalary.res.vtl']).toContain('Authorization rule:');
  expect(out.resolvers['Subscription.onDeleteSalary.res.vtl']).toMatchSnapshot();
  expect(out.resolvers['Subscription.onUpdateSalary.res.vtl']).toContain('Authorization rule:');
...
test('that checks subscription resolvers are created without auth logic', () => {
  ...
  expect(out.resolvers['Subscription.onCreateSalary.res.vtl']).toMatchSnapshot();
  expect(out.resolvers['Subscription.onDeleteSalary.res.vtl']).not.toContain('Authorization rule:');
  expect(out.resolvers['Subscription.onDeleteSalary.res.vtl']).toMatchSnapshot();
  expect(out.resolvers['Subscription.onUpdateSalary.res.vtl']).not.toContain('Authorization rule:');
  expect(out.resolvers['Subscription.onUpdateSalary.res.vtl']).toMatchSnapshot();
});
...
test('that subscriptions are only generated if the respective mutation operation exists', () => {
  ...
  expect(out.resolvers['Subscription.onUpdateSalary.res.vtl']).toContain('Authorization rule:');
  expect(out.resolvers['Subscription.onUpdateSalary.res.vtl']).toMatchSnapshot();
  expect(out.resolvers['Subscription.onDeleteSalary.res.vtl']).toBeUndefined();
});
