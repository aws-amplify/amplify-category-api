...
NULL,NULL,"articles","pub_id",NULL,1,"integer","int4","NO",NULL,"articles_pkey","pub_id, pub_type"
NULL,NULL,"articles","pub_type","'A'::bpchar",2,"character","bpchar","NO",1,"articles_pkey","pub_id, pub_type"
NULL,NULL,"comments","comment_timestamp","now()",2,"timestamp without time zone","timestamp","NO",NULL,"comments_pkey","pub_id, comment_timestamp, commenter_email"
NULL,NULL,"comments","commenter_email",NULL,3,"character varying","varchar","NO",10,"comments_pkey","pub_id, comment_timestamp, commenter_email"
NULL,NULL,"comments","pub_id",NULL,1,"integer","int4","NO",NULL,"comments_pkey","pub_id, comment_timestamp, commenter_email"
NULL,NULL,"publications","pub_id",NULL,1,"integer","int4","NO",NULL,"publications_pkey","pub_id"
NULL,NULL,"publications","pub_id",NULL,1,"integer","int4","NO",NULL,"publications_superkey","pub_id, pub_type"
NULL,NULL,"publications","pub_type",NULL,2,"character","bpchar","YES",1,"publications_superkey","pub_id, pub_type"
NULL,NULL,"publications","pub_url",NULL,3,"character varying","varchar","NO",64,"publications_pub_url_key","pub_url"
...
NULL,NULL,"comments","commenter_email",NULL,3,"character varying","varchar","NO",10,"comments_pkey","pub_id, comment_timestamp, commenter_email"
NULL,NULL,"comments","pub_id",NULL,1,"integer","int4","NO",NULL,"comments_pkey","pub_id, comment_timestamp, commenter_email"
NULL,NULL,"pub","pub_id",NULL,1,"integer","int4","NO",NULL,"publications_pkey","pub_id"
NULL,NULL,"pub","pub_id",NULL,1,"integer","int4","NO",NULL,"publications_superkey","pub_id, pub_type"
NULL,NULL,"pub","pub_type",NULL,2,"character","bpchar","YES",1,"publications_superkey","pub_id, pub_type"
NULL,NULL,"pub","pub_url",NULL,3,"character varying","varchar","NO",64,"publications_pub_url_key","pub_url"
NULL,NULL,"stories","placeholder",NULL,3,"character","bpchar","NO",1,NULL,NULL
NULL,NULL,"stories","pub_id",NULL,1,"integer","int4","NO",NULL,"stories_pkey","pub_id, pub_type"
NULL,NULL,"stories","pub_type","'S'::bpchar",2,"character","bpchar","NO",1,"stories_pkey","pub_id, pub_type"`,
  },
