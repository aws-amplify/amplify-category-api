 ...
 */
export const assistantStreamingMutationResolver = (config: ConversationDirectiveConfiguration): MappingTemplateProvider => {
  let resolver = fs.readFileSync(path.join(__dirname, 'assistant-streaming-mutation-resolver-fn.template.js'), 'utf8');
