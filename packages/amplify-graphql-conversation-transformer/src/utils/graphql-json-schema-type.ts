...
export const convertGraphQlTypeToJsonSchemaType = (graphQlType: string): string => {
    switch (graphQlType) {
        ...
        case 'AWSDate': return 'string';
        case 'AWSTime': return 'string';
        case 'AWSTimestamp': return 'string';
        case 'AWSEmail': return 'string';
        case 'AWSJSON': throw new Error('AWSJson is not supported')
        default:
