...
export function overrideDDB(cwd: string, settings: object) {
  return new Promise((resolve, reject) => {
...
export function buildOverrideStorage(cwd: string, settings: object) {
  return new Promise((resolve, reject) => {
...
export function overrideS3(cwd: string, settings: object) {
  return new Promise((resolve, reject) => {
    const args = ['override', 'storage'];
    spawn(getCLIPath(), args, { cwd, stripColors: true })
      .wait('Do you want to edit override.ts file now?')
