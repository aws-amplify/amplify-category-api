...
describe('graphqlToCedar', () => {
  it('parses a simple public schema', () => {
    ...
    `;
    console.log(`### Amplify schema:\n${schema}`);

    const cedarBundle = graphqlToCedar(schema);
    expect(cedarBundle.policies).toBeDefined();
    console.log(`### Auto-generated Cedar policies:\n${JSON.stringify(cedarBundle.policies, null, 2)}`);
